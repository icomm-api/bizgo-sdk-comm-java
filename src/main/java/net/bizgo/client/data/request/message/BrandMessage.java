...
import net.bizgo.client.data.code.SendType;
import net.bizgo.client.data.code.ServiceType;
import net.bizgo.client.data.request.kakao.Carousel;
import net.bizgo.client.data.request.kakao.attachment.Attachment;
...
public class BrandMessage {
    ...
    public static class Builder {
        ...
        public BrandMessage build() {
            ...
            if (!ServiceType.BRANDMESSAGE.supports(msgType)) {
