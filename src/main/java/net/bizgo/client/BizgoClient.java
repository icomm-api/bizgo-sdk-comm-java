...
public class BizgoClient {
    ...
    public BizgoResponse send(OmniRequest omni) throws Exception {
        return omniService.execute(omni);
    }

    public BizgoResponse upload(FileRequest file) throws Exception {
        return fileService.execute(file);
    }

    public BizgoResponse inquireStatistics(String startDate) throws Exception {
        return messageStatisticsInquiryService.inquire(startDate);
    }

    public BizgoResponse inquireStatistics(String startDate, String endDate) throws Exception {
        return messageStatisticsInquiryService.inquire(startDate, endDate);
    }

    public BizgoResponse inquireStatistics(String startDate, String endDate, String serviceType, String groupKey) throws Exception {
        return messageStatisticsInquiryService.inquire(startDate, endDate, serviceType, groupKey);
    }

    public BizgoResponse inquireHistory(String requestTime) throws Exception {
        return messageHistoryInquiryService.inquire(requestTime);
    }

    public BizgoResponse inquireHistory(String requestTime, String serviceType) throws Exception {
        return messageHistoryInquiryService.inquire(requestTime, serviceType);
    }

    public BizgoResponse inquireHistory(String requestTime, String serviceType, String groupKey, String lastSeq, Integer limit) throws Exception {
        return messageHistoryInquiryService.inquire(requestTime, serviceType, groupKey, lastSeq, limit);
    }

    public BizgoResponse inquireStatusByMsgKey(String msgKey) throws Exception {
        return messageStatusInquiryService.inquireByMsgKey(msgKey);
    }

    public BizgoResponse inquireStatusByRequestId(String requestId) throws Exception {
        return messageStatusInquiryService.inquireByRequestId(requestId);
    }

    public BizgoResponse get(ReportInquiryRequest req) throws Exception {
        return reportInquiryService.execute(req);
    }

    public BizgoResponse get(ReportPollingRequest req) throws Exception {
        req.setMethod("GET");
        return reportPollingService.execute(req);
    }

    public BizgoResponse remove(ReportPollingRequest req) throws Exception {
