...
public class HttpWrapper {
     ...
     */
    public HttpWrapper(HttpConfig httpConfig, AuthService authService, MarsService marsService) {
    ...
    public RequestBuilder applyAuth(RequestBuilder request) throws IOException {
        ...
        } else if (marsService != null) {
            return marsService.init(request);  // <-- 추가
        } else {
            return request; // 인증 없이 보냄 (권장 X)
        }
    }
